...
Personal use is permitted **only for natural persons**
acting in a private, non-commercial, non-professional capacity.

Any use by a legal entity (company, startup, NGO, institution),
including internal testing, study, benchmarking, integration,
or infrastructure use, requires a paid commercial license from Korvex.
